function create_clickable_element_for_url(script_num_in, label_for_clickable_url, url_for_clickable) {
    ...
    insert_string += '    <button data_tooltip="Copy Command to Clipboard." data-copytarget="#clickable_command_' + script_num_in + '">Click Copy</button>';
    insert_string += '    <button data_tooltip="View Script at GitHub." onclick=" window.open(\'https://gist.github.com/' + url_for_clickable + '\',\'_blank\')">View Gist</button>';
    insert_string += '  </div>';
